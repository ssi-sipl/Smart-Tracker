...
ITL_EXPORT ITLResult_t itl_set_default_values(BTProductCode_t productCode);
...
ITL_EXPORT ITLResult_t itl_set_parameter_f32(bt_parameter_enum_t parameterType, float32_it value);
ITL_EXPORT ITLResult_t itl_set_parameter_ui16(bt_parameter_enum_t parameterType, uint16_it value);
ITL_EXPORT ITLResult_t itl_set_parameter_si16(bt_parameter_enum_t parameterType, sint16_it value);

ITL_EXPORT ITLResult_t itl_get_parameter_f32(bt_parameter_enum_t parameterType, float32_it *pValue);
ITL_EXPORT ITLResult_t itl_get_parameter_ui16(bt_parameter_enum_t parameterType, uint16_it *pValue);
ITL_EXPORT ITLResult_t itl_get_parameter_ui32(bt_parameter_enum_t parameterType, uint32_it *pValue);
ITL_EXPORT ITLResult_t itl_get_parameter_si16(bt_parameter_enum_t parameterType, sint16_it *pValue);
